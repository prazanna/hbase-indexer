...
/**
 * Extracts byte arrays from column qualifiers based on a matching prefix in the column qualifier.
 */
public class PrefixMatchingQualifierExtractor extends AbstractPrefixMatchingExtractor {

    public PrefixMatchingQualifierExtractor(byte[] columnFamily, byte[] qualifierPrefix) {
